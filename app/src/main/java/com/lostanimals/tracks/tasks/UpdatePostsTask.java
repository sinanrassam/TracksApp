		...
		if (json != null) {
			...
			try {
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					...
					String imageLocation = (String) jsonObject.get("image_location");
					
					PostsUtility.addPostEntry(i, new PostEntry(id, title, desc, username, date, time, found, imageLocation));
