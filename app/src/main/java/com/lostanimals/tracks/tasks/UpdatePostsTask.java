...
public class UpdatePostsTask extends AsyncTask<String, Integer, Boolean> {
    ...
    protected void onPostExecute(final Boolean success) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(mContext, mPostList, android.R.layout.simple_list_item_2,
                new String[]{"Title", "Desc"}, new int[]{android.R.id.text1, android.R.id.text2});
